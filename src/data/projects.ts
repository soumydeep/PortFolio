...
export const projects: Project[] = [
  {
    ...
    challenges: "One of the main challenges was implementing real-time updates on the Kanban Board. So implement the proper logic with use of state management and itteration over the data." 
  },
  {
    title: "Apparel Store",
    description: "An e-commerce platform for a fashion brand that contains basic ecom features with strong implementation behind",
